...
RIPEstat-derived geographic/ASN policy, and CrowdSec ingress bans. Docker
coexistence, complete observability, systemd packaging, and signed RPM/DEB releases
are part of that target, not all currently available features.
...
| [Data sources](docs/data-sources.md) | RIPEstat/cache contracts and CrowdSec wire compatibility, authority, projection, and leases |
